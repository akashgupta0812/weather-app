...
function displayResults (weather) {
     document.querySelector(".loading").classList.remove("active-loading")
    console.log("dispay result ",weather);
    console.log(weather.cod);
    if(weather.cod==404) 
    { 
        document.querySelector(".board").classList.remove("active")
        return document.querySelector(".warning").classList.add("active")
